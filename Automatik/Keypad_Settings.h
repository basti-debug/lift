...
//PORT, PIN
#define Keypad_R0			B, 4
#define Keypad_R1			B, 5
#define Keypad_R2			B, 6
#define Keypad_R3			B, 7
#define Keypad_C0			D, 7
#define Keypad_C1			D, 6
#define Keypad_C2			D, 5
#define Keypad_C3			D, 4
//----------------------------------------------//
#endif